...
supplied. On that run one channel clears the pre-set relevance margin of $0.03$ and two do not.
Protein target clears it on all three constructions: count-matched \ci{+0.1498}{+0.0958}{+0.2038},
plate-matched \ci{+0.1351}{+0.0745}{+0.1958}, and the stricter different-plate requirement
\ci{+0.1322}{+0.0648}{+0.1996}. Mechanism excludes zero on all three
...
channel that clears a relevance margin against a different-plate null with the partner pool
restricted to training drugs, and is therefore where a model may be able to do something a
dictionary cannot. That
