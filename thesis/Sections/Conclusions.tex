...
That arm was later re-run at the residual arm's $1400$-token budget, where it clears zero against
the neutral comparator too, which is what the next sentence turns on.) Re-encoding
