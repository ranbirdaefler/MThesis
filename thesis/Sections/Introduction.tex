...
inverse rank has a positive dynamic range fraction --- $+0.635$ across plates and $+0.519$ within
plate, against $-0.16$ to $-0.69$ for the other four across plates and $-0.12$ to $-0.50$ within
plate. The across-plates figure is measured with the bootstrap clustered on the $25$ cell lines
rather than on the $1{,}820$ drug rows nested in them, $[+0.604, +0.663]$ with Holm $p = 0.002$; the
within-plate figure awaits the same repair and is quoted as a point estimate. We
