...
the unseen-drug question is actually about, the target gap is
$+0.1197$ \nolinebreak[3]$[+0.0671, +0.1720]$ on those two drugs, mechanism falls from $+0.0805$ to
$+0.0439$ \nolinebreak[3]$[-0.0021, +0.0921]$ and spans zero on four, and chemistry reads
$+0.0378$ \nolinebreak[3]$[+0.0157, +0.0620]$ on fourteen. What this section measures is therefore
...
($+0.0439$ \nolinebreak[3]$[-0.0021, +0.0921]$); it cannot carry an unseen-drug claim in any
