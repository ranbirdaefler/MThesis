...
inspected. Those three rates are written to each run's log rather than tabulated here, so what the
chapter carries per evaluation is the generation budget, which is the part of the block a reader
cannot reconstruct. The generation configuration itself is
