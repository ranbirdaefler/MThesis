...
do not cover it: sampling at temperature $0.8$ with top-$p$ $0.9$ throughout, and three generation
...
evaluations of \S\ref{sec:res-encoding}, and $600$ with four in the control arms until they were
re-run at the residual arm's budget (\S\ref{sec:res-encoding}). Where a null turns on the budget it
