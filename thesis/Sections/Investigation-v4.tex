...
$+0.0044$),
and the two highest rungs do not ($\alpha = 5$ and $10$ span zero, as an empirical class-mean
displacement amplified far beyond its observed scale can). But applying the $26$-test correction to the $\alpha = 1$ slice instead
