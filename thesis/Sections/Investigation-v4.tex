...
mixes cell line, dose, well and estimator --- not a pure interaction \\
...
drug$\times$cell-line interaction share would require all three of the other axes to be inert, and
nothing here establishes that. The dose arm below is the exception: it holds drug and cell line fixed
and varies only molar concentration, so its contrast is clean.
...
cannot express ($44.7\%$ of the drug-specific residual is not shared across contexts, though that
figure mixes several axes); no learnable structure in it is found; and re-encoding
...
\S\ref{sec:res-transfer} measures descriptively at $44.7\%$ of the residual. It is also why the lookup
