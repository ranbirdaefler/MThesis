...
been re-run with the restriction in place. The repair narrowed what may be claimed: protein target
clears the relevance margin, mechanism misses its lower bound by $0.0021$, and chemistry's interval
straddles the margin, so only the target channel supports a statement that unseen-drug
generalisation is reachable through retrieval.
