...
token sequence exposes to the loss. That is a fact about the target's tokens; it does not on its own
identify tokenisation as the binding constraint (Table~\ref{tab:divergence}).}
\label{fig:frame}
\end{figure}
