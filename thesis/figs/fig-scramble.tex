...
the evidence is not a free choice --- a usable null is one whose own score sits at chance, and
\S\ref{sec:res-generalisation} finds that true of exactly one of the three, the neutral
\texttt{orth} partner. Every gap in this chapter is measured against that one; the other two strata
are read as diagnostics.}
\label{fig:scramble}
\end{figure}
