...
comparison is not leak-immune, and a zero-drug-information control-copy baseline scores $\NIR =
0.766$ cross-plate precisely because it inherits that leakage. A refinement matters here and is
